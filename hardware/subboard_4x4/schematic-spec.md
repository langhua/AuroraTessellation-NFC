...
| ESP32-S3-WROOM-1 模块 | 库内已建 `ESP32-S3-WROOM-1_1.fzpz` | 半孔焊盘裸模块（schematic/PCB 用，IO0~IO48）；面包板原型用带排针的 DevKitC-1 开发板 |
...
4. ✅ 建立 `ESP32-S3-WROOM-1` 模块符号（schematic/PCB 用，IO0~IO48/GND/3V3/EN/5Vin，2026-08-30 已换）；面包板原型另用 DevKitC-1 开发板。
